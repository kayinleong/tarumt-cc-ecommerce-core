...
import { ProductCategoryCreateRequest, ProductCategoryUpdateRequest } from "../types/requests/product-category.request";
...
export class ProductCategoryService {
  ...
  public getById(
    ...
    return this.http.get<ProductCategoryResponse>(
      `${environment.api.baseUrl}/admin/product_category/${id}?isDeleted=${is_deleted}&isSuspended=${is_suspended}`
    );
  }

  public create(product: ProductCategoryCreateRequest): Observable<void> {
    return this.http.post<void>(`${environment.api.baseUrl}/admin/product_category/`, product);
  }

  public updateById(id: string, product: ProductCategoryUpdateRequest): Observable<void> {
